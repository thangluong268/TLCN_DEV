...
const HasPermitRole_middleware_1 = require("./middleware/HasPermitRole.middleware");
...
exports.UserModule = UserModule = __decorate([
    (0, common_1.Module)({
        imports: [mongoose_1.MongooseModule.forFeature([{ name: 'User', schema: user_schema_1.UserSchema }]), ability_module_1.AbilityModule, role_module_1.RoleModule],
        controllers: [user_controller_1.UserController],
        providers: [user_service_1.UserService, FreedomCustom_exception_1.default],
